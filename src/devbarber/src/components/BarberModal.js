    ...
    <Modal 
      ...
      <ModalArea>
        <ModalBody>
          ...
          <Image  source={require('../assets/expand.png')}style={{tintColor:"#000000", width: 40,height: 40}}/>
          </CloseButton>
          ...
          <ModalItem>
            <DateInfo>
              ...
              <Image  source={require('../assets/NavPrev.png')}style={{tintColor:"#000000", width: 35,height: 35}}/>
              ...
              <Image  source={require('../assets/Navnext.png')}style={{tintColor:"#000000", width: 35,height: 35}}/>
